CREATE PROCEDURE createZoo2
AS 
BEGIN
		CREATE TABLE tbl_care (
		care_id VARCHAR(50) NOT NULL PRIMARY KEY,
	...
	INSERT INTO tbl_care
		...
		('care_1', 'repair broken toy', 4),
		('care_2', 'feed viatamins', 1),
		('care_3', 'human contact_pet subject', 2),
		('care_4', 'clean up animal waste', 1),
		('care_5', 'move subject to excedrsize pen', 3),
	...
	INSERT INTO tbl_habitat
		...
		('ice aquarium with snowy facade', 50000),
	...
	INSERT INTO tbl_specialist
		...
		VALUES
		('margaret', 'nyguen', '360-334-0337'),
		('mary','fischer','384-784-4856'),
		('arnold','holden','385-475-3944'),
		('kem','byesan','384-485-2679'),
		('delmonte','fyedo','384-288-3749')
	;
	...
	SELECT
		...
		a3.nutrition_type, 13.nutrition_cost
		FROM tbl_species a1
		INNER JOIN tbl_habitat a2 ON a2.habitat_id = species_habitat
		INNER JOIN tbl_nutrition a3 ON a3.nutrition_id = species_nutrition
